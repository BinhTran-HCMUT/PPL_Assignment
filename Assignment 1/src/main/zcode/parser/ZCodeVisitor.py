...
class ZCodeVisitor(ParseTreeVisitor):
    ...
    # Visit a parse tree produced by ZCodeParser#unmatchifstmt.
    def visitUnmatchifstmt(self, ctx:ZCodeParser.UnmatchifstmtContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by ZCodeParser#matchifstmt.
    def visitMatchifstmt(self, ctx:ZCodeParser.MatchifstmtContext):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by ZCodeParser#noncondstmt.
    def visitNoncondstmt(self, ctx:ZCodeParser.NoncondstmtContext):
        return self.visitChildren(ctx)
